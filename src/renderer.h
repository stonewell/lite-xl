...
double ren_draw_text_gpu(RenWindow *window_renderer, RenFont **font, const char *text, size_t len, float x, int y, RenColor color, RenTab tab);

void ren_draw_rect(RenSurface *rs, RenRect rect, RenColor color);
void ren_draw_rect_gpu(RenWindow *window_renderer, RenRect rect, RenColor color);
